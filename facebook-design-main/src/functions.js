const member = document.querySelector(".user_post_list");

let post_list = "";

user_post.reverse().forEach((item, index) => {
  post_list += `<div class="user-post">
            <div class="user-post-header">
              <div class="post-info">
                <img src="${item.authur.photos}" alt="" />
                <div class="user-details">
                  <a class="author" href="#">${item.authur.name}</a>
                  <span
                    >${item.authur.time}d
                    <svg
                      fill="currentColor"
